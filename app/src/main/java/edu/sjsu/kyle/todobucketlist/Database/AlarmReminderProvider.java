...
public class AlarmReminderProvider extends ContentProvider {
    ...
    static {
        ...
        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_TASKS, REMINDER);

        sUriMatcher.addURI(AlarmReminderContract.CONTENT_AUTHORITY, AlarmReminderContract.PATH_TASKS + "/#", REMINDER_ID);
