...
import edu.sjsu.kyle.todobucketlist.Reminder.AlarmScheduler;
...
public class AddTaskActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the all the fields and variable values
        setValues();
    ...
    {
        // Initialize Views
        mTitleText = (EditText) findViewById(R.id.toAddItem);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case android.R.id.home:
                ...
                // which is the {@link ToDoActivity}.
                if (!mTaskHasChanged) {
